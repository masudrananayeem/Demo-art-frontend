...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    // Dashboards
    { title: "Admin Dashboard", url: "/admin/dashboard", group: "Dashboards", icon: LayoutDashboard },

    // Admin Auth
    { title: "Admin Login", url: "/admin/login", group: "Auth", icon: Shield },
    ...
    // Pages (none for now; add as needed)
  ]
